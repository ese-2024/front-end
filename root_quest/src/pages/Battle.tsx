...
function Battle() {
    return (
        <div className="bg-colorBase h-full w-full flex justify-start items-center flex-col overflow-y-auto">
            ...
            <div className="w-11/12 mt-7 font-chakra-regular text-2xl text-textC">ABAIXO SEGUEM AS TASKS AGRUPADAS POR NÍVEIS DE DIFICULDADE. PARA DESBLOQUEAR A TASK OU NÍVEL SEGUINTE É NECESSÁRIO A CONCLUSÃO DO ITEM ANTERIOR.</div>
